...
CREATE TABLE products(seller VARCHAR(255), size varchar (255), id INT (11) PRIMARY KEY AUTO_INCREMENT NOT NULL, category  varchar (255) NOT NULL, product varchar( 255 ) NOT NULL, quantity INT (11) NOT NULL,  colors varchar (255) NOT NULL,  image varchar(255), price INT (11) NOT NULL, new_price INT (11), status Varchar (255) NOT NULL, amount_sold INT (11) NOT NULL, description text, reviews text, product_id INT (11) NOT NULL, sale_type varchar (255), date DATETIME  DEFAULT CURRENT_TIMESTAMP);


CREATE TABLE info( user INT(11) NOT NULL, subject varchar( 255 ) NOT NULL, date DATETIME  DEFAULT CURRENT_TIMESTAMP);

CREATE TABLE category( category varchar( 255 ) NOT NULL, lft INT(11) NOT NULL, rgt INT (11) NOT NULL);

CREATE TABLE sellers( user_id INT( 11 ) NOT NULL, username varchar(255) NOT NULL, store varchar (255) NOT NULL, date_joined DATETIME DEFAULT CURRENT_TIMESTAMP);
